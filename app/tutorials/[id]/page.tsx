...
export default function TutorialPage({ params }: { params: { id: string } }) {
  ...
  const { article, isLoading, error } = useArticleById("tutoriels", id)
      ...
      <div className="flex min-h-screen flex-col mx-auto px-4 items-center">
        ...
        <main className="flex-1 py-12 md:py-16">
          <div className="container text-center">
            ...
            <p className="text-muted-foreground mb-8">Le tutoriel que vous recherchez n'existe pas ou a été déplacé.</p>
            <Link href="/tutorials">
              <Button>
    ...
    <div className="flex min-h-screen flex-col mx-auto px-4 items-center">
      ...
      <main className="flex-1">
        <article className="container max-w-4xl py-12 md:py-16">
          <Link href="/tutorials" className="inline-flex items-center text-sm mb-4 text-muted-foreground hover:text-foreground">
            <ArrowLeft className="mr-2 h-4 w-4" />
            Back to tutorials
          </Link>
