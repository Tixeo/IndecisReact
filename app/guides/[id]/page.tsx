...
export default function GuidePage({ params }: { params: { id: string } }) {
  ...
  const { article, isLoading, error } = useArticleById("guides", id)
      ...
      <div className="flex min-h-screen flex-col mx-auto px-4 items-center">
        ...
        <main className="flex-1 py-12 md:py-16">
          <div className="container text-center">
            ...
            <p className="text-muted-foreground mb-8">The guide you are looking for does not exist or has been moved.</p>
            <Link href="/guides">
              <Button>
    ...
    <div className="flex min-h-screen flex-col mx-auto px-4 items-center">
      ...
      <main className="flex-1">
        <article className="container max-w-4xl py-12 md:py-16">
          <Link href="/guides" className="inline-flex items-center text-sm mb-4 text-muted-foreground hover:text-foreground">
            <ArrowLeft className="mr-2 h-4 w-4" />
            Back to guides
          </Link>
