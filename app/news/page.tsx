...
export default function NewsPage() {
  ...
  const { articles, isLoading, error } = useArticlesByCategory("news")
  ...
  const filteredNews = articles ? articles.filter(guide => {
          ...
          <div className="container">
            <div className="mx-auto max-w-[800px] text-center">
              ...
              <p className="mb-8 text-muted-foreground md:text-xl">
                Discover the latest news and updates about Discord.
              </p>
          ...
          <div className="container">
            ...
            {isLoading ? (
              ...
              <div className="text-center py-10">
                <p className="text-lg text-red-500">Error loading news. Please try again later.</p>
              </div>
            ) : (
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {filteredNews.length === 0 ? (
                  <div className="col-span-full text-center py-10">
                    <p className="text-lg text-muted-foreground">No news match your search.</p>
                  </div>
                ) : (
                  filteredNews.map((guide) => (
                    <Link href={`/news/${guide.numeric_id}`} key={guide.id} className="group">
